...
import { PAGINATION_DEFAULT_AVAILABLE_ORDER_BY, PAGINATION_DEFAULT_AVAILABLE_ORDER_DIRECTION, PAGINATION_DEFAULT_ORDER_BY, PAGINATION_DEFAULT_ORDER_DIRECTION } from '../constants/pagination.constant';
...
export function PaginationOrderPipe(defaultOrderBy: string = PAGINATION_DEFAULT_ORDER_BY, defaultOrderDirection: ENUM_PAGINATION_ORDER_DIRECTION_TYPE = PAGINATION_DEFAULT_ORDER_DIRECTION, availableOrderBy: string[] = PAGINATION_DEFAULT_AVAILABLE_ORDER_BY): Type<PipeTransform> {
  ...
  class MixinPaginationOrderPipe implements PipeTransform {
    ...
    async transform(value: Record<string, any>): Promise<Record<string, any>> {
      ...
      const availableOrderDirection: ENUM_PAGINATION_ORDER_DIRECTION_TYPE[] = PAGINATION_DEFAULT_AVAILABLE_ORDER_DIRECTION;
