...
import { FileImportException } from '../exceptions/file.import.exception';
...
@Injectable()
export class FileExcelValidationPipe<T, N = Record<string, any>>implements PipeTransform {
  ...
  async validateParse(value: IFileRows<N>[], classDtos: any): Promise<IFileRows<T>[]> {
