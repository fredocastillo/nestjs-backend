...
export function LessThanEqualOtherProperty(property: string, validationOptions?: ValidationOptions) {
...
export function LessThanOtherProperty(property: string, validationOptions?: ValidationOptions) {
  return function (object: Record<string, any>, propertyName: string): void {
    registerDecorator({
