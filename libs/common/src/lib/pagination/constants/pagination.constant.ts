...
export const PAGINATION_DEFAULT_ORDER_DIRECTION: ENUM_PAGINATION_ORDER_DIRECTION_TYPE = ENUM_PAGINATION_ORDER_DIRECTION_TYPE.ASC;

export const PAGINATION_DEFAULT_AVAILABLE_ORDER_BY: string[] = ['createdAt'];
export const PAGINATION_DEFAULT_AVAILABLE_ORDER_DIRECTION: ENUM_PAGINATION_ORDER_DIRECTION_TYPE[] = Object.values(ENUM_PAGINATION_ORDER_DIRECTION_TYPE);
